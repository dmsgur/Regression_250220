...
d2.set_img(1,{imgtitle:"당뇨데이터불러오기",imgurl:"https://drive.google.com/file/d/15n8SUNP5BR33NgAT62weoD5lMhPJ2vyL/view?usp=drive_link",imglog:"임신횟수,혈장,혈압등의 8개 특성 데이터 판다스를 이용하여 로드 및 분석",sourceurl:"https://github.com/dmsgur/Regression_250220/tree/codeone/binary_classification_diabetes"})//이미지타이틀
d2.set_img(1,{imgtitle:"히스토그램분석1",imgurl:"https://drive.google.com/file/d/1UWLAMaTPTDsVp047eCqOr2RdutEN_z_A/view?usp=drive_link",imglog:"특성별 이상치데이터 판별과 특성 데이터의 분포를 시각화",sourceurl:"https://github.com/dmsgur/Regression_250220/tree/codeone/binary_classification_diabetes"})//이미지타이틀
d2.set_img(1,{imgtitle:"히스토그램분석2",imgurl:"https://drive.google.com/file/d/1hdnzHFpFK-JteOmICmAZptbx7Y3fXH3l/view?usp=drive_link",imglog:"특성별 이상치데이터 판별과 특성 데이터의 분포를 시각화",sourceurl:"https://github.com/dmsgur/Regression_250220/tree/codeone/binary_classification_diabetes"})//이미지타이틀
d2.set_img(1,{imgtitle:"데이터분할",imgurl:"https://drive.google.com/file/d/1vB1ztyL2HwLIDSsjXCDGG_sxBoOk-CPP/view?usp=drive_link",imglog:"훈련데이터 80%, 검증데이터 10%, 테스트데이터 10% 분할",sourceurl:"https://github.com/dmsgur/Regression_250220/tree/codeone/binary_classification_diabetes"})//이미지타이틀
d2.set_img(1,{imgtitle:"데이터전처리",imgurl:"https://drive.google.com/file/d/1RNZWxQ_Hp1MUbN2LmGMhBHMAJ9e-rm_J/view?usp=drive_link",imglog:"데이터 정규분포로 표준화후 변경 데이터 확인",sourceurl:"https://github.com/dmsgur/Regression_250220/tree/codeone/binary_classification_diabetes"})//이미지타이틀
d2.set_img(1,{imgtitle:"모델구성및컴파일 훈련",imgurl:"https://drive.google.com/file/d/1TAPJ5vqP0A5koA-ZKuvv21ugIby7DTwc/view?usp=drive_link",imglog:"이진분류모델 구성과 모델의 컴파일후 훈련데이터와 검증데이터로 훈련실행",sourceurl:"https://github.com/dmsgur/Regression_250220/tree/codeone/binary_classification_diabetes"})//이미지타이틀
d2.set_img(1,{imgtitle:"훈련결과 시각화",imgurl:"https://drive.google.com/file/d/1yWDEx09VPrn92TDrhvFfEdqOqYLyjAd1/view?usp=drive_link",imglog:"손실도와 정확도를 훈련데이터와 검증데이터를 시각화하여 분석",sourceurl:"https://github.com/dmsgur/Regression_250220/tree/codeone/binary_classification_diabetes"})//이미지타이틀
d2.set_img(1,{imgtitle:"모델평가",imgurl:"https://drive.google.com/file/d/1FVejpUOlXAn7w6Zpsu7Txq4HbjDK_GUc/view?usp=drive_link",imglog:"테스트 문제데이터와 정답테이터를 입력하여 정확도 손실율 출력",sourceurl:"https://github.com/dmsgur/Regression_250220/tree/codeone/binary_classification_diabetes"})//이미지타이틀
d2.set_img(1,{imgtitle:"혼동행렬및시각화",imgurl:"https://drive.google.com/file/d/1Cfd4fzjCU4WiAVUiiPkSTuxJ871FNDrZ/view?usp=drive_link",imglog:"혼동행렬출력후 히트맵을 이용하여 결과를 시각화후 1종오류와 2종 오류 수치 확인",sourceurl:"https://github.com/dmsgur/Regression_250220/tree/codeone/binary_classification_diabetes"})//이미지타이틀
d2.set_img(1,{imgtitle:"정밀도와 재현율",imgurl:"https://drive.google.com/file/d/158NruGO-tvL-JRZUaQ7YdFchhr1T_D7k/view?usp=drive_link",imglog:"정밀도 및 재현율과 f1-score 요약 출력",sourceurl:"https://github.com/dmsgur/Regression_250220/tree/codeone/binary_classification_diabetes"})//이미지타이틀
